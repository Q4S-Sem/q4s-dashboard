...
export default async function WeekVerwerkenPage() {
  ...
  const plaatsingen: WizardPlaatsing[] = placements.map((p) => ({
    ...
    config: {
      ...
      // De zes losse toeslagen moeten mee, anders rekent de voorbeeldweergave in
      // de wizard een ander bedrag dan de factuur die eruit komt.
      weekdaySurchargeBuy: p.weekdaySurchargeBuy,
      weekdaySurchargeSell: p.weekdaySurchargeSell,
      weekdaySurchargeUnit: p.weekdaySurchargeUnit,
      weekdaySurchargeSellUnit: p.weekdaySurchargeSellUnit,
      saturdaySurchargeBuy: p.saturdaySurchargeBuy,
      saturdaySurchargeSell: p.saturdaySurchargeSell,
      saturdaySurchargeUnit: p.saturdaySurchargeUnit,
      saturdaySurchargeSellUnit: p.saturdaySurchargeSellUnit,
      sundaySurchargeBuy: p.sundaySurchargeBuy,
      sundaySurchargeSell: p.sundaySurchargeSell,
      sundaySurchargeUnit: p.sundaySurchargeUnit,
      sundaySurchargeSellUnit: p.sundaySurchargeSellUnit,
      offshoreEnabled: p.offshoreEnabled,
      offshoreSurchargeBuy: p.offshoreSurchargeBuy,
      offshoreSurchargeSell: p.offshoreSurchargeSell,
      offshoreSurchargeUnit: p.offshoreSurchargeUnit,
      offshoreSurchargeSellUnit: p.offshoreSurchargeSellUnit,
      shiftEnabled: p.shiftEnabled,
      shiftSurchargeBuy: p.shiftSurchargeBuy,
      shiftSurchargeSell: p.shiftSurchargeSell,
      shiftSurchargeUnit: p.shiftSurchargeUnit,
      shiftSurchargeSellUnit: p.shiftSurchargeSellUnit,
      abroadEnabled: p.abroadEnabled,
      abroadSurchargeBuy: p.abroadSurchargeBuy,
      abroadSurchargeSell: p.abroadSurchargeSell,
      abroadSurchargeUnit: p.abroadSurchargeUnit,
      abroadSurchargeSellUnit: p.abroadSurchargeSellUnit,
    },
  }));
