...
/**
 * Gedeelde sollicitatielijst. Wordt op twee plekken getoond: in de
 * Recruitment-hub (/sollicitaties) en in de Website-hub
 * (/website/sollicitaties). `basePath` houdt alle links binnen de werkplek
 * waar je bent, zodat je niet ongevraagd van hub wisselt.
 */
export async function SollicitatiesList({
  sp,
  basePath = "/sollicitaties",
}: {
  sp: { status?: string };
  basePath?: "/sollicitaties" | "/website/sollicitaties";
}) {
