...
/**
 * Gedeelde sollicitatie-detailkaart (Recruitment- én Website-hub). `basePath`
 * bepaalt waar Terug heen wijst en waar de acties na afloop terugkeren.
 */
export async function SollicitatieDetail({
  id,
  error,
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {(application.status === "REJECTED" ||
              ...
              <form action={reopenApplication}>
                ...
                <input type="hidden" name="base" value={basePath} />
