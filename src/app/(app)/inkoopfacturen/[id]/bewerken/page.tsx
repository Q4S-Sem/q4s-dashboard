...
import { InvoiceEditForm } from "../../../facturen/InvoiceEditForm";
import { updatePurchaseInvoice } from "../../actions";

export const metadata = { title: "Inkoopfactuur bewerken" };
...
export default async function InkoopBewerkenPage({
  params,
}: {
