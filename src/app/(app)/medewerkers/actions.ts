...
const EmployeeSchema = z.object({
  ...
  pensionStart: z.coerce.date().optional(),
  pensionEmployeePct: z.coerce.number().min(0).optional(),
  pensionEmployerPct: z.coerce.number().min(0).optional(),
...
function toData(d: z.infer<typeof EmployeeSchema>) {
  ...
  return {
    ...
    pensionScheme: orNull(d.pensionScheme),
    pensionNumber: orNull(d.pensionNumber),
    pensionStart: d.pensionStart ?? null,
    pensionEmployeePct: d.pensionEmployeePct ?? null,
    pensionEmployerPct: d.pensionEmployerPct ?? null,
