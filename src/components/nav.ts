...
const HUB_LIST: NavHub[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/verwerken/controle", label: "Urencontrole", icon: ShieldCheck, section: "Verwerken" },
      ...
      { href: "/betalingen", label: "Betalingen (SEPA)", icon: Banknote, section: "Betalen & bewaken" },
      { href: "/betaalmonitor", label: "Betaalmonitor", icon: BellRing, section: "Betalen & bewaken" },
